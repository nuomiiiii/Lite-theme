...
test("homepage uses a card-style status overview with a light health gradient", () => {
  ...
  assert.match(overview, /minmax\(260px,380px\)_minmax\(184px,212px\)_minmax\(184px,212px\)/)
  ...
  assert.doesNotMatch(overview, /truncate text-\[36px\]/)
  assert.match(overview, /formatted\.unit/)
  assert.match(overview, /items-baseline gap-x-1\.5/)
  assert.match(overview, /containerType: "inline-size"/)
  assert.match(overview, /grid-cols-\[minmax\(0,1fr\)_auto\]/)
  assert.match(overview, /flex h-4 w-full shrink-0 items-center/)
  assert.doesNotMatch(overview, /mt-1\.5 block text-right/)
